...
class Other(Sustenance):
  name = "other"
  urls = ["http://bit.ly/2w50PPl", "http://bit.ly/2wvacZz", "http://bit.ly/2xzkm8u", "http://bit.ly/2wF5Hfr", "http://bit.ly/2xzpGZn",
  ...
  def __init__(self, name=name, urls=urls):
    Sustenance.__init__(self, name, urls)
